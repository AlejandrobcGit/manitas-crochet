...
class ColorServiceTest {
        ...
        void actualizaYElimina() {
                ...
                when(figuraRepository.existsByColoresIdsContaining("1")).thenReturn(false);
        ...
        @Test
        void eliminarLanzaExcepcionSiColorEstaEnUso() {

                when(repository.existsById("1")).thenReturn(true);
                when(figuraRepository.existsByColoresIdsContaining("1")).thenReturn(true);

                assertThatThrownBy(() -> service.eliminar("1"))
                                .isInstanceOf(ColorEnUsoException.class);
